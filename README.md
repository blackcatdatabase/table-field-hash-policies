...
> Schema package for table **field_hash_policies** (repo: `field-hash-policies`).
...
| effective_from | TIMESTAMPTZ(6) | NO | CURRENT_TIMESTAMP(6) |  |
| notes | TEXT | YES | — |  |

## Relationships
- FK → **hash_profiles** via (profile_id) (ON DELETE RESTRICT).
...
erDiagram
  ...
  FIELD_HASH_POLICIES }o--|| HASH_PROFILES : "profile_id"
```
