...
namespace BlackCat\Database\Packages\FieldHashPolicies;
...
use BlackCat\Database\Packages\FieldHashPolicies\Repository\FieldHashPolicyRepository as GeneratedRepository;
...
{
  private FieldHashPolicyRepositoryInterface $repo;
  ...
  public function __construct(private Database $db)
  {
    ...
    public function _setRepositoryForTests(RepoContract $repo): void
    {
        ...
        if (!$repo instanceof FieldHashPolicyRepositoryInterface) {
            // Allow any repo that conforms to the interface even if not generated
            throw new \InvalidArgumentException('Expected FieldHashPolicyRepositoryInterface');
        }
        $this->repo = $repo;
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\FieldHashPolicies\Dto\FieldHashPolicyDto|null { return $this->repo->getByUnique($keys, $asDto); }
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\FieldHashPolicies\Dto\FieldHashPolicyDto|null { return $this->repo->getById($id, $asDto); }
