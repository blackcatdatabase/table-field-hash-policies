...
use BlackCat\Database\Packages\FieldHashPolicies\Repository\FieldHashPolicyRepository;
...
{
    private FieldHashPolicyRepository $repo;

    public function __construct(private Database $db)
    {
        $this->repo = new FieldHashPolicyRepository($db);
    }
    ...
    public function getByUnique(array $keys, bool $asDto = false): array|\BlackCat\Database\Packages\FieldHashPolicies\Dto\FieldHashPolicyDto|null
    {
        return $this->repo->getByUnique($keys, $asDto);
    }

    /** @return array<string,mixed>|\BlackCat\Database\Packages\FieldHashPolicies\Dto\FieldHashPolicyDto|null */
    public function getById(int|string|array $id, bool $asDto = false): array|\BlackCat\Database\Packages\FieldHashPolicies\Dto\FieldHashPolicyDto|null
    {
