...
namespace BlackCat\Database\Packages\FieldHashPolicies\Mapper;

use BlackCat\Database\Packages\FieldHashPolicies\Dto\FieldHashPolicyDto;
use BlackCat\Database\Packages\FieldHashPolicies\Definitions;
use DateTimeZone;
use BlackCat\Database\Support\DtoHydrator;

/**
 * Bidirectional mapper between DB rows and DTO FieldHashPolicyDto:
 ...
 */
final class FieldHashPolicyDtoMapper
{
    /** @var array<string,string> Column -> DTO property */
    private const COL_TO_PROP = [ 'id' => 'id', 'entity_table' => 'entityTable', 'field_name' => 'fieldName', 'profile_id' => 'profileId', 'effective_from' => 'effectiveFrom', 'notes' => 'notes', 'created_at' => 'createdAt', 'updated_at' => 'updatedAt' ];

    /** @var string[] */
    private const BOOL_COLS   = [];
    /** @var string[] */
    private const INT_COLS    = [ 'id', 'profile_id' ];
    /** @var string[] */
     ...
     * @return FieldHashPolicyDto
     */
    public static function fromRow(array $row): FieldHashPolicyDto
    {
        /** @var FieldHashPolicyDto */
        return DtoHydrator::fromRow(
            FieldHashPolicyDto::class,
            $row,
            self::COL_TO_PROP,
            self::BOOL_COLS,
            self::INT_COLS,
    ...
    public static function fromRowOrNull(?array $row): ?FieldHashPolicyDto
    {
     ...
     *
     * @param FieldHashPolicyDto   $dto
     * @param string[]|null   $onlyProps  optional whitelist of DTO properties to serialize
     * @return array<string,mixed>
     */
    public static function toRow(FieldHashPolicyDto $dto, ?array $onlyProps = null): array
    {
    ...
    public static function toRowNonNull(FieldHashPolicyDto $dto, ?array $onlyProps = null): array
    {
     ...
     * @return array<string,mixed>
     */
    public static function diff(FieldHashPolicyDto $dto, array $original, array $ignore = [], bool $coerce = true): array
    {
        $now = self::toRow($dto);
     ...
     * @return array<int,FieldHashPolicyDto>
     */
    public static function hydrateList(array $rows): array
    {
        /** @var array<int,FieldHashPolicyDto> */
    ...
    /** @return array<string,mixed> */
    public static function toSafeArray(FieldHashPolicyDto $dto): array
    {
        $row = self::toRow($dto);
     ...
     * @return \Generator<int,FieldHashPolicyDto>
     */
