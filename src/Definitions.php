...
final class Definitions {
    // --- core metadata ---
    public static function table(): string { return 'field_hash_policies'; }
    public static function contractView(): string { return 'vw_field_hash_policies'; }
    /** @return string[] */
    public static function columns(): array { return [ 'id', 'entity_table', 'field_name', 'profile_id', 'effective_from', 'notes', 'created_at', 'updated_at' ]; }
    ...
    public static function uniqueKeys(): array { return [ [ 'entity_table', 'field_name', 'effective_from' ], [ 'id' ] ]; }
    ...
    public static function intColumns(): array { return [ 'id', 'profile_id' ]; }
