...
final class FieldHashPoliciesModule implements ModuleInterface
{
    public function name(): string { return 'table-field_hash_policies'; }
    public function table(): string { return 'field_hash_policies'; }
    public function version(): string { return '1.0.0'; }

    /** @return string[] */
    public function dialects(): array { return [ 'mysql', 'postgres' ]; }
    /** @return string[] */
    public function dependencies(): array { return [ 'table-hash_profiles' ]; }

    public static function contractView(): string { return 'vw_field_hash_policies'; }
    ...
    public function status(Database $db, SqlDialect $d): array
    {
        ...
        $expectedIdx = [ 'idx_fhp_entity_field' ];
        $expectedFk  = [ 'fk_fhp_profile' ];
    ...
    public function info(): array
    {
        return [
            ...
            'indexes'     => [ 'idx_fhp_entity_field' ],
            'foreignKeys' => [ 'fk_fhp_profile' ],
        ];
    }
}
